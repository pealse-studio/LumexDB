...
exports.default = new forgescript_1.NativeFunction({
    name: "$getVar",
    version: "1.0.0",
    description: "Get variable value by type and name, optionally for an entity",
    brackets: true,
    unwrap: true,
    args: [
        {
    ...
    execute(ctx, [type, name, id, guild]) {
        if (type === "global") {
            return this.success((0, database_1.getVar)(type, name));
        }
        ;
        ...
        ;
        return this.success((0, database_1.getVar)(type, name, String(key)));
    },
});
